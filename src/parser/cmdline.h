...
#define CMDLINE_PARSER_PACKAGE "ec_test"
#endif

#ifndef CMDLINE_PARSER_PACKAGE_NAME
/** @brief the complete program name (used for help and version) */
#define CMDLINE_PARSER_PACKAGE_NAME "ec_test"
#endif
...
struct gengetopt_args_info
{
  ...
  char * index_orig;	/**< @brief EtherCAT device index original value given at command line.  */
  const char *index_help; /**< @brief EtherCAT device index help description.  */
