...
const char *gengetopt_args_info_purpose = "parse EtherCAT configuration xml and start EtherCAT master";

const char *gengetopt_args_info_usage = "Usage: ec_test [OPTION]...";
...
cmdline_parser_release (struct gengetopt_args_info *args_info)
{
  ...
  free_string_field (&(args_info->index_orig));
...
cmdline_parser_dump(FILE *outfile, struct gengetopt_args_info *args_info)
{
  ...
  if (args_info->index_given)
    write_into_file(outfile, "index", args_info->index_orig, 0);
  ...
  while (1)
    {
      ...
      switch (c)
        ...
        case 'v':	/* Increase program verbosity.  */
          ...
          break;
        case 'i':	/* EtherCAT device index.  */
        
        
          if (update_arg( (void *)&(args_info->index_arg), 
               &(args_info->index_orig), &(args_info->index_given),
              &(local_args_info.index_given), optarg, 0, "0", ARG_INT,
              check_ambiguity, override, 0, 0,
              "index", 'i',
              additional_error))
            goto failure;
